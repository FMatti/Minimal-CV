...
% Blue
%\definecolor{minimal-main}{HTML}{132747}
%\definecolor{minimal-light}{HTML}{e8f2fa}
%\definecolor{minimal-contrast}{HTML}{F3F2F5}

% Green
%\definecolor{minimal-main}{HTML}{0c2b0e}
%\definecolor{minimal-light}{HTML}{ebf2eb}
%\definecolor{minimal-contrast}{HTML}{F3F2F5}

% Red
%\definecolor{minimal-main}{HTML}{3b0101}
%\definecolor{minimal-light}{HTML}{f5e8e4}
%\definecolor{minimal-contrast}{HTML}{F3F2F5}
